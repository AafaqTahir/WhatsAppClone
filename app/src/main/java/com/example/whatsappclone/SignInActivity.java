        ...
        binding.btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(binding.etEmailin.getText().toString().isEmpty()){
                    binding.etEmailin.setError("This field can't be empty");
                    flag = false;
                }
                if(binding.etPasswordin.getText().toString().isEmpty()){
                    binding.etPasswordin.setError("This field can't be empty");
                    flag = false;
                }
                if(flag){
                    progressDialog.show();
                    firebaseAuth.signInWithEmailAndPassword(binding.etEmailin.getText().toString().trim() ,
                            binding.etPasswordin.getText().toString().trim()).
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            firebaseDatabase.getReference().child("Users").child(user.getUid()).setValue(muser);
                            Intent intent = new Intent(SignInActivity.this, MainActivity.class);
                            startActivity(intent);
                            Toast.makeText(SignInActivity.this, "Signed in with google account", Toast.LENGTH_SHORT).show();
                            //updateUI(user);
                        } else {
